...
cat > package.json << EOL
{
  ...
  "scripts": {
    "dev": "concurrently \\"yarn dev:web\\" \\"yarn dev:mobile\\"",
    "dev:web": "yarn workspace @todoapp/web dev",
    "dev:mobile": "yarn workspace @todoapp/mobile start",
    "build:web": "yarn workspace @todoapp/web build",
    "lint:web": "yarn workspace @todoapp/web lint",
    "clean": "rimraf node_modules web/node_modules mobile/node_modules common/node_modules yarn.lock && echo '🧹 Clean complete!'",
...
echo "✅ MonoToDo monorepo is fully set up with Yarn v1!"
