...
+(NSString *)sipUri:(NSString *)uri fromAccount:(Account *)account {
    ...
    NSString *sipUri = [UriFormatter sipUri:uri];
...
+(Contact *)contactFromURI:(NSString *)uri {
    ...
    if ([uri length] == 0) {
        return [[Contact alloc] initWithName:nil address:nil];
    }
    ...
    if ([uri rangeOfString:@"<"].location == NSNotFound && [uri rangeOfString:@">"].location == NSNotFound) {
        ...
        return [[Contact alloc] initWithName:nil address:[[uri stringByReplacingOccurrencesOfString:@"sip:" withString:@""] stringByReplacingOccurrencesOfString:@"\"" withString:@""]];
    }
    ...
    return [[Contact alloc] initWithName:[name stringByTrimmingCharactersInSet:spaceSet] address:[address stringByTrimmingCharactersInSet:spaceSet]];
}
